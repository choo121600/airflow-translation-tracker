class BadgeGenerator {
  ...
  generateSVG(label, message, color, options = {}) {
    ...
    const messageX = labelWidth + logoWidth + messageWidth / 2 + 14; // Adjusted for better centering with increased padding
  ...
  createSVGContent(label, message, color, labelWidth, messageWidth, labelX, messageX, logoWidth, logo, style) {
    ...
    const messageBgWidth = messageWidth + 16; // Additional padding for better percentage spacing
