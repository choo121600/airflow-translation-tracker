class BadgeGenerator {
  ...
  generateSVG(label, message, color, options = {}) {
    ...
    // Center text within each rectangle section
    const labelX = labelBgWidth / 2; // Center in left rectangle
    const messageX = messageBgX + messageBgWidth / 2; // Center in right rectangle
  ...
  createSVGContent(label, message, color, labelWidth, messageWidth, labelX, messageX, logoWidth, logo, style) {
    ...
    const messageBgWidth = messageWidth + 14; // Balanced padding with less right margin
